...
export function TeachScreen() {
  ...
  return <PageTransition>
    <main aria-label="Teach">
      ...
      <p className="page-subtitle mt-3">Explain it in your own words. I’m listening.</p>
      <p className="quiet-note mt-3">{session.material.title}</p>
